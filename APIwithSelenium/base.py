...
def mass_follow(account,user_name):
    instagram_bot = commands.InstaBot(account[1]["username"], account[1]["password"],)
    #instagram_bot.follow_user(user_name)
    print(account[1]["username"], account[1]["password"], sep="\t")
    print(user_name)
...
def follow_thread():
    ...
    accounts_filepath = os.path.join(app.root_path, "accounts.csv")
